...
hfs -put ../../'Yahoo%20Finance%20Stock%20Market%20Data'/'spark_calculations'/'S&P_500_aggregate'/'S&P_500_aggregate_Top_5_Gains.csv' 

hfs -rm -r 'S&P_500_aggregate_Top_5_Drops.csv' 
hfs -put ../../'Yahoo%20Finance%20Stock%20Market%20Data'/'spark_calculations'/'S&P_500_aggregate'/'S&P_500_aggregate_Top_5_Drops.csv' 
...
spark-submit --conf spark.pyspark.python=/share/apps/python/3.6.5/bin/python calculations_join.py 'S&P_500_aggregate_Top_5_Gains.csv' 'S&P_500_aggregate_Top_5_Drops.csv' 'all_news_by_date.csv' 
