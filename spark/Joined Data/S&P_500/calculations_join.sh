...
hfs -put ../../'Stock%20Data'/'spark_calculations'/'S&P_500'/'S&P_500_Top_5_Gains.csv' 

hfs -rm -r 'S&P_500_Top_5_Drops.csv' 
hfs -put ../../'Stock%20Data'/'spark_calculations'/'S&P_500'/'S&P_500_Top_5_Drops.csv' 

hfs -rm -r 'S&P_500_Specific_Day_Gains.csv' 
hfs -put ../../'Stock%20Data'/'spark_calculations'/'S&P_500'/'S&P_500_Specific_Day_Gains.csv' 

hfs -rm -r 'S&P_500_Specific_Day_Gains_Top_10.csv' 
hfs -put ../../'Stock%20Data'/'spark_calculations'/'S&P_500'/'S&P_500_Specific_Day_Gains_Top_10.csv' 

hfs -rm -r 'S&P_500_Specific_Day_Drops.csv' 
hfs -put ../../'Stock%20Data'/'spark_calculations'/'S&P_500'/'S&P_500_Specific_Day_Drops.csv' 

hfs -rm -r 'S&P_500_Specific_Day_Drops_Top_10.csv' 
hfs -put ../../'Stock%20Data'/'spark_calculations'/'S&P_500'/'S&P_500_Specific_Day_Drops_Top_10.csv' 
...
spark-submit --conf spark.pyspark.python=/share/apps/python/3.6.5/bin/python ../../../spark/'Joined Data'/'S&P_500'/calculations_join.py 'S&P_500_Top_5_Gains.csv' 'S&P_500_Top_5_Drops.csv' 'S&P_500_Specific_Day_Gains.csv' 'S&P_500_Specific_Day_Gains_Top_10.csv' 'S&P_500_Specific_Day_Drops.csv' 'S&P_500_Specific_Day_Drops_Top_10.csv' 'all_news_by_date.csv' 
