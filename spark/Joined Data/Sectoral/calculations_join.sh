...
hfs -put ../../'Stock%20Data'/'spark_calculations'/'Sectoral'/'Sector_Top_5_Gains.csv' 

hfs -rm -r 'Sector_Top_5_Drops.csv' 
hfs -put ../../'Stock%20Data'/'spark_calculations'/'Sectoral'/'Sector_Top_5_Drops.csv' 

hfs -rm -r 'Sector_Specific_Day_Gains.csv' 
hfs -put ../../'Stock%20Data'/'spark_calculations'/'Sectoral'/'Sector_Specific_Day_Gains.csv' 

hfs -rm -r 'Sector_Specific_Day_Gains_Top_1.csv' 
hfs -put ../../'Stock%20Data'/'spark_calculations'/'Sectoral'/'Sector_Specific_Day_Gains_Top_1.csv' 

hfs -rm -r 'Sector_Specific_Day_Drops.csv' 
hfs -put ../../'Stock%20Data'/'spark_calculations'/'Sectoral'/'Sector_Specific_Day_Drops.csv' 

hfs -rm -r 'Sector_Specific_Day_Drops_Top_1.csv' 
hfs -put ../../'Stock%20Data'/'spark_calculations'/'Sectoral'/'Sector_Specific_Day_Drops_Top_1.csv' 
...
spark-submit --conf spark.pyspark.python=/share/apps/python/3.6.5/bin/python ../../../spark/'Joined Data'/'Sectoral'/calculations_join.py 'Sector_Top_5_Gains.csv' 'Sector_Top_5_Drops.csv' 'Sector_Specific_Day_Gains.csv' 'Sector_Specific_Day_Gains_Top_1.csv' 'Sector_Specific_Day_Drops.csv' 'Sector_Specific_Day_Drops_Top_1.csv' 'all_news_by_date.csv' 
