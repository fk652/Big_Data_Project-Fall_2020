  ...
  render() {
    return (
      ...
      >
        ...
        <Legend />
        <Line connectNulls type="monotone" dataKey="USA Covid Cases LogChangeCumulative" stroke="#8884d8" dot={false} />
        <Line connectNulls type="monotone" dataKey="USA_StringencyIndex_LogChangeCumulative" stroke="#82ca9d" dot={false} />
      </LineChart>
    );
  }
}